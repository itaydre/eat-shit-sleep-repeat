(function (root, factory) {
    ...
    function formatBabyAge(age, gender) {
        ...
        if (age.unit === 'days') return emoji + age.value + 'd old';
        if (age.unit === 'weeks') {
            return emoji + age.value + 'w' + (age.fraction ? ' ' + age.fraction + 'd' : '') + ' old';
        }
        return emoji + age.value + 'm' + (age.fraction ? ' ' + age.fraction + 'd' : '') + ' old';
    }
